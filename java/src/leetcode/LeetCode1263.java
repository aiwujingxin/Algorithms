 ...
 * @date 2023/4/25 20:58
 * <a href="https://leetcode.com/problems/minimum-moves-to-move-a-box-to-their-target-location/solutions/431431/java-straightforward-bfs-solution/">...</a>
 */
    ...
    public int minPushBox(char[][] grid) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int[] move : moves) {
                ...
                // if it meets the box, then the box move in the same direction
                if (nsx == b[0] && nsy == b[1]) {
                    int nbx = b[0] + move[0];
                    int nby = b[1] + move[1];
