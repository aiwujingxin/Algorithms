 ...
 * @see knowledge.algorithms.dp.memoization     记忆化搜索：自顶向下递归 + 缓存，等价于逆拓扑序递推
 * @see knowledge.algorithms.dp.probabilitydp   概率期望DP：借助期望线性性顺推概率 / 逆推期望
 * @see knowledge.algorithms.dp.gamedp          博弈论：SG 函数 + 游戏和，公平组合游戏的胜负判定
 */
public interface DP {
}
